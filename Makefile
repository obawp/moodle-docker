...
bkp_mkdir:
	...
	- sudo chown $$USER:www-data ${VOLUME_DIR}/backup/${CURRENT_BACKUP_DIR}
	- sudo chown $$USER:www-data ${VOLUME_DIR}/backup/${CURRENT_BACKUP_DIR}/html
	- sudo chown $$USER:www-data ${VOLUME_DIR}/backup/${CURRENT_BACKUP_DIR}/data
	- sudo chown $$USER:www-data ${VOLUME_DIR}/backup/${CURRENT_BACKUP_DIR}/plugins
